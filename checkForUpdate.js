...
var resp = api.env.control.ExecCmdById(envName, session, nodeId, toJSON([{ command: "curl --silent https://raw.githubusercontent.com/sych74/wordpress-cli/main/japp.sh > ~/bin/japp.sh && bash ~/bin/japp.sh checkForUpdate" }]));
